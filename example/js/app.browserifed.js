...
var Liquify = function (options) {
  ...
  this._renderer = new Renderer(this.templates);
...
Liquify.prototype.render = function () {
  var data = arguments[0]; // throw error if not given
  ...
  this._renderer.render_to_page(data, template, target, callback);
};
...
Liquify.prototype._invoke_action = function (current_data) {
  ...
  this.current_slug = lqfy.last_from_path(current_data.url);
...
},{"./liquify/actioner.js":3,"./liquify/data_object.js":4,"./liquify/defaults":5,"./liquify/extensions":7,"./liquify/renderer.js":8,"./liquify/router.js":9}],3:[function(require,module,exports){
var $       = require('jquery');
var Eventer = require('./eventer.js');

// TODO:
//  - set e.currentTargets class to active
//  - parent link (make another link active when the current one is)
...
*/
},{"./eventer.js":6,"jquery":10}],4:[function(require,module,exports){
require('./extensions');
...
DataObjectBuilder.prototype._from_array = function () {
  ...
  for (var i = 0; i < this.data.length; i++) {
    ...
    dataObj = _this._set_item(dataObj, key, item, true); // prop name key
    if (typeof key === 'string') dataObj = _this._set_item(dataObj, i, item); // array name key
  }
...
},{"./extensions":7}],5:[function(require,module,exports){
var LiquifyDefaults = {
...
},{"./extensions":7,"jquery":10,"liquid.js":11}],9:[function(require,module,exports){
RegExp.escape = function (s) {
  return s.replace(/[-\/\\^$*+?.()|[\]{}]/g, '\\$&');
};

// TODO:
//  - history state (sperate class ?)
